    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = BaseApplication.myApplication.getApplicationContext().getExternalCacheDir() + File.separator + "log" + File.separator;

            } else {
                dir = BaseApplication.myApplication.getApplicationContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
